  ...
  return (
    <Navbar
      ...
      className={`rounded-xl transition-all ${
        fixedNavbar
          ? "shadow-blue-gray-500/5 sticky top-4 z-40 py-3 shadow-md"
          : "px-0 py-1"
      }`}
      fullWidth
      blurred={fixedNavbar}
        ...
        <div className="flex items-center">
          ...
          <Menu>
            ...
            <MenuList className="border-0 w-max">
              ...
              <MenuItem className="flex items-center gap-4">
                <div className="grid rounded-full from-blue-gray-800 to-blue-gray-900 h-9 w-9 place-items-center bg-gradient-to-tr">
